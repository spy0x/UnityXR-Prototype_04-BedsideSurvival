Shader "Hidden/Universal Render Pipeline/UberPostHDR"
{
    HLSLINCLUDE
        ...
        half4 FragUberPost(Varyings input) : SV_Target
        {
            ...
            half3 color = (0.0).xxx;
            float alpha = SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, SCREEN_COORD_REMOVE_SCALEBIAS(uvDistorted)).w;
